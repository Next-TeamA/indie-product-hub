...
const EVENT_TYPES = [
  { value: "promotion",  label: "Promotion",  dot: "bg-blue-500",    badge: "bg-blue-50 text-blue-700 dark:bg-blue-950/40 dark:text-blue-400"    },
  { value: "deployment", label: "Deploy",     dot: "bg-violet-500",  badge: "bg-violet-50 text-violet-700 dark:bg-violet-950/40 dark:text-violet-400" },
  { value: "marketing",  label: "Marketing",  dot: "bg-pink-500",    badge: "bg-pink-50 text-pink-700 dark:bg-pink-950/40 dark:text-pink-400"    },
  { value: "meeting",    label: "Meeting",    dot: "bg-emerald-500", badge: "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400" },
  { value: "other",      label: "Other",      dot: "bg-amber-500",   badge: "bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400"   },
] as const;
                    ...
                    {day && (
                      <>
                        ...
                        <div className="mt-1 flex flex-col gap-0.5">
                          ...
                          {dayEvents.length > 3 && (
                            <span className="text-[10px] text-muted-foreground pl-2.5">+{dayEvents.length - 3}</span>
                          )}
                        </div>
                      </>
                    )}
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-2 pt-1">
                  ...
                  <button
                    onClick={addEvent}
                    disabled={isSaving}
                    className="flex-1 h-10 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors cursor-pointer disabled:opacity-40"
                  >
